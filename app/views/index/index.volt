              ...
              <div class="col s12 m6 l3">
                <div class="card">
                  ...
                  <div class="card-action  deep-orange darken-1">
                    <div id="invoice-line" class="center-align"><canvas style="display: inline-block; width: 402.417px; height: 25px; vertical-align: top;" width="402" height="25"></canvas></div>
                  </div>
                </div>
              </div>
            </div>
