        ...
        <nav class="navbar-color gradient-45deg-light-blue-cyan">
            <div class="nav-wrapper">
                    ...
                    <li>
                        <h1 class="logo-wrapper">
                            <a href="index.html" class="brand-logo darken-1">
                                ...
                                <span class="logo-text hide-on-med-and-down">WebStats</span>
                            </a>
                        </h1>
                    </li>
                </ul>
                <div class="header-search-wrapper hide-on-med-and-down">
                    ...
                    <input type="text" name="Search" class="header-search-input z-depth-2" placeholder="Explore WebStats" />
                </div>
    ...
    <div class="footer-copyright">
        <div class="container center-align">
            <span>
                ...
                </script> <a class="grey-text text-lighten-4" href="https://www.adec-innovations.com/" target="_blank">ADEC Innovations</a> All rights reserved.
            </span>
